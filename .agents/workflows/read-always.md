# WorkTracker Context Enforcement

## MANDATORY: READ ON STARTUP

Whenever a session starts in the `worktracker` (Time Guardian) project, you MUST perform the following actions before any other work:
